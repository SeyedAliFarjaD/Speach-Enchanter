...
class NoiseCancellationSimulator {
  ...
  async _initMicrophone() {
    ...
    const audio = new Audio("./media/01_Hekmate_Sadraei_Asalate_Vojood_aminikhaah.ir.mp3");
  ...
  async _initNoiseReducer() {
    await audioCtx.audioWorklet.addModule("./src/NoiseCancellationProcessor.js");
